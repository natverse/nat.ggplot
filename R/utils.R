...
#' \describe{
#'   \item{coord_fixed()}{Maintains aspect ratio for accurate morphology}
#'   \item{theme_void()}{Removes all standard plot elements}
...
#' Simply add your geom_neuron() layers to this base object.
#'
#' @examples
#' \dontrun{
#' library(nat.ggplot)
