...
lists of objects. A worked example — an [exploded view of the fly
neuropils](exploding-neuropils.html), where every `JFRC2` neuropil moves out and back
without overlapping — is its own vignette.
